...
TEST(LinearAlgebraTest, RANDOM1) {
    using ::testing::AllOf;
    using ::testing::Ge;
    using ::testing::Lt;
...
TEST(LinearAlgebraTest, MULTIPLY2) {
...
TEST(LinearAlgebraTest, MULTIPLY3) {
...
TEST(LinearAlgebraTest, MULTIPLY4) {
...
TEST(LinearAlgebraTest, DETERMINANT1) {
...
TEST(LinearAlgebraTest, DETERMINANT2) {
    // test case
    Matrix matrix{{1, 1.5, -1.75, 2}, {2, 2.5, -2.75, 3}, {3, 3.5, -3.75, 4}, {4, 4.5, 4.75, 5}};
    EXPECT_DOUBLE_EQ(algebra::determinant(matrix), 0);
}

TEST(LinearAlgebraTest, INVERSE1) {
...
TEST(LinearAlgebraTest, INVERSE2) {
    // test case
...
TEST(LinearAlgebraTest, CONCATENATE1) {
...
TEST(LinearAlgebraTest, CONCATENATE2) {
    // Caution: matrices with wrong dimensions cannot be concatenated
...
TEST(LinearAlgebraTest, ERO_SWAP) {
...
TEST(LinearAlgebraTest, ERO_MULTIPLY) {
    Matrix matrix{algebra::random(4, 3, 0, 4)};
...
TEST(LinearAlgebraTest, ERO_SUM) {
    Matrix matrix{algebra::random(4, 3, 0, 4)};
...
TEST(LinearAlgebraTest, UPPER_TRIANGULAR1) {
