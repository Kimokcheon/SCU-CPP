...
struct Login {
    ...
    static void readFile(const std::string& path); // reads the .txt file, then register the user inside readFile using theregisterUser function
    ...
    void changeUsername(const std::string& username, std::string newUsername);

    void changePassword(const std::string& username, std::string newPassword);

    void changeMail(const std::string& username, std::string newMail, const std::string& password);
